...
#
# Generated by export_simulation on Wed May 15 19:03:26 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './w_bram_3.sh' script.

./w_bram_3.sh -reset_run
...
./w_bram_3.sh -noclean_files

For more information on the script, please type './w_bram_3.sh -help'.
