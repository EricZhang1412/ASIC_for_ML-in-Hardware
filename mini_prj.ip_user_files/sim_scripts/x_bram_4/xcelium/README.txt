...
#
# Generated by export_simulation on Fri May 17 16:04:16 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './x_bram_4.sh' script.

./x_bram_4.sh -reset_run
...
./x_bram_4.sh -noclean_files

For more information on the script, please type './x_bram_4.sh -help'.
