...
#
# Generated by export_simulation on Thu May 16 02:23:08 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './w_bram_1.sh' script.

./w_bram_1.sh -reset_run
...
./w_bram_1.sh -noclean_files

For more information on the script, please type './w_bram_1.sh -help'.
