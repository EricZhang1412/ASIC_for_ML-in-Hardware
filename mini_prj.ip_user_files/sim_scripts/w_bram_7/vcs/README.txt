...
#
# Generated by export_simulation on Fri May 17 15:59:28 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './w_bram_7.sh' script.

./w_bram_7.sh -reset_run
...
./w_bram_7.sh -noclean_files

For more information on the script, please type './w_bram_7.sh -help'.
