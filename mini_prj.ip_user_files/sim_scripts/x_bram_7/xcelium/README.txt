...
#
# Generated by export_simulation on Wed May 15 18:59:42 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './x_bram_7.sh' script.

./x_bram_7.sh -reset_run
...
./x_bram_7.sh -noclean_files

For more information on the script, please type './x_bram_7.sh -help'.
