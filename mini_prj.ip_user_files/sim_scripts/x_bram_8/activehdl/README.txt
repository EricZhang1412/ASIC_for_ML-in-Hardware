...
#
# Generated by export_simulation on Wed May 15 19:00:43 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './x_bram_8.sh' script.

./x_bram_8.sh -reset_run
...
./x_bram_8.sh -noclean_files

For more information on the script, please type './x_bram_8.sh -help'.
