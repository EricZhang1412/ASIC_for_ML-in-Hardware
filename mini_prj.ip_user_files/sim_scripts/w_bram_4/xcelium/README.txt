...
#
# Generated by export_simulation on Wed May 15 19:05:08 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './w_bram_4.sh' script.

./w_bram_4.sh -reset_run
...
./w_bram_4.sh -noclean_files

For more information on the script, please type './w_bram_4.sh -help'.
