...
#
# Generated by export_simulation on Wed May 15 21:37:27 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './w_bram_8.sh' script.

./w_bram_8.sh -reset_run
...
./w_bram_8.sh -noclean_files

For more information on the script, please type './w_bram_8.sh -help'.
