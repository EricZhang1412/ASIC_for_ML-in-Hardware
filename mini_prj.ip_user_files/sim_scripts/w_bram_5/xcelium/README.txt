...
#
# Generated by export_simulation on Wed May 15 20:53:16 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './w_bram_5.sh' script.

./w_bram_5.sh -reset_run
...
./w_bram_5.sh -noclean_files

For more information on the script, please type './w_bram_5.sh -help'.
