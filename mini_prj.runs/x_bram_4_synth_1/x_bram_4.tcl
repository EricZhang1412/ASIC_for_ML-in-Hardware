...
synth_design -top x_bram_4 -part xc7z020clg400-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix x_bram_4_ x_bram_4.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ x_bram_4_stub.v
 lappend ipCachedFiles x_bram_4_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ x_bram_4_stub.vhdl
 lappend ipCachedFiles x_bram_4_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ x_bram_4_sim_netlist.v
 lappend ipCachedFiles x_bram_4_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ x_bram_4_sim_netlist.vhdl
 lappend ipCachedFiles x_bram_4_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp x_bram_4.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips x_bram_4]
 }
...
rename_ref -prefix_all x_bram_4_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef x_bram_4.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "x_bram_4_synth_1_synth_report_utilization_0" "report_utilization -file x_bram_4_utilization_synth.rpt -pb x_bram_4_utilization_synth.pb"
