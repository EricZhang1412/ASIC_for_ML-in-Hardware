...
HD_PWD='E:/VivadoWS/ASIC_for_ML-in-Hardware/mini_prj.runs/w_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log w_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source w_bram_1.tcl
