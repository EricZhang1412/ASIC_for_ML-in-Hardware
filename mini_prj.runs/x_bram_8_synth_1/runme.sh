...
HD_PWD='E:/VivadoWS/ASIC_for_ML-in-Hardware/mini_prj.runs/x_bram_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x_bram_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x_bram_8.tcl
